...
class CustomUser(User):
    ...
    numMentees = models.IntegerField(default=0)
    numMentors = models.IntegerField(default=0)
    atWork = models.BooleanField()
    
    #This is one way to handle relationships between entities
    interests = models.ManyToManyField("Interest", related_name='UserInterest')
    expertise = models.ManyToManyField("Interest", related_name='UserExpertise', blank = True)
